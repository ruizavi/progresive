...
import { ArrayParser, BooleanParser, DateParser, FloatParser, IntegerParser, StringParser } from "../middleware/parser";
...
function HttpRequestFactory(type: RequestInformation) {
	return function (
		...
		return function (target, propertyKey, index) {
			...
			const params: HttpRequest[] = Reflect.hasMetadata(HTTP_REQUEST_METADATA, controllerClass)
